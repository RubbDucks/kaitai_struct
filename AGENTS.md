...
- `tests/build-compiler` and `tests/build-formats` now honor `KAITAI_COMPILER_ENGINE` (`scala` default, `cpp17` opt-in); unset it to roll back quickly to Scala wiring.
